...
modell:  character.o game_location.o item.o io.o model.o login_manager.o 
		g++ -g -o modell character.o game_location.o item.o io.o model.o login_manager.o -g 

game_location.o: model/game_location.cpp model/game_location.h
		g++ -g -c -Wall -pedantic -std=c++14 model/game_location.cpp

item.o: model/item.cpp model/item.h
		g++ -g -c -Wall -pedantic -std=c++14 model/item.cpp

login_manager.o: model/login_manager.cpp model/login_manager.h
	    g++ -g -c -Wall -pedantic -std=c++14  model/login_manager.cpp

io.o: model/io.cpp model/io.h
		g++ -g -c -Wall -Wuninitialized -pedantic -std=c++14 model/io.cpp

character.o: model/character.cpp model/character.h
		g++ -g -c -Wall -pedantic -std=c++14 model/character.cpp

model.o: model/model.cpp model/model.h
		g++ -g -c -Wall -Wuninitialized -pedantic -std=c++14 model/model.cpp
...
command.o: controller/command.cpp controller/command.h
		g++ -g -c -Wall -pedantic -std=c++14 controller/command.cpp

controller.o: controller/controller.cpp controller/controller.h
		g++ -g -c -Wall -pedantic -std=c++14 controller/controller.cpp
...
display_manager.o: view/display_manager.cpp view/display_manager.h
		g++ -g -c -Wall -pedantic -std=c++14 view/display_manager.cpp



clean:
		rm -rf *.o game *out.txt
